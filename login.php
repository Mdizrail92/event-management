        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['loginbtn'])) {
            ...
            if (isset($_SESSION['email'])) {
                ...
                if ($count) {
                    ...
                    echo "<div class='alert alert-danger'>
                            <strong>Error!</strong> Invalid credentials <br> Account Does not exist . Please sign up.
                            </div>";
                }
            } else {
                echo "<div class='alert alert-danger'>
        ...
        <div class="container text-center">
            ...
            <div id="user-login">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
                    ...
                    <button type="submit" value="submit" name="loginbtn" class="btn btn-primary">Login<i class="fas fa-sign-in-alt"></i></button>
                </form>
                </br></br>
